...
public class PlaylistAutomatica extends Playlist {
    ...
    public void atualizar(ArrayList<Musica> todasMusicas) {
        ...
        if (criterio.equalsIgnoreCase("top")) {
            ...
            // Simula "recentes": últimas 5 adicionadas ao banco
